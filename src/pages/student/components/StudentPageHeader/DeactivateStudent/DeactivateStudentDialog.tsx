...
interface DeactivateStudentDialogProps {
    apiResponse: DefaultApiResponse<Student>;
    show: (show: boolean) => void;
}

function DeactivateStudentDialog(props: DeactivateStudentDialogProps): React.ReactElement {
        ...
        <Dialog open={true} onClose={(): void => show(false)}>
            <DialogContent>
                {apiResponse && apiResponse.success ? (
                    <Typography component={"span"}>El estudiante ha sido dado de baja correctamente</Typography>
                ) : (
